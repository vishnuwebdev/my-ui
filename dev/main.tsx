...
const App: React.FC = () => (
  <div className='p-6 space-y-4 gap-2'>
    ...
    <div className='flex flex-col gap-2 flex-wrap'>
      ...
      <Button color='bg-green-600 text-white hover:bg-green-700'>Custom Green</Button>

      <Button color='bg-purple-500 text-white hover:bg-purple-600'>Purple Power</Button>
